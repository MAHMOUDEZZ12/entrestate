    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        <PageHeader
          ...
          description="Each Suite is a self-contained ecosystem of apps, data, and workflows designed to master a core area of your business. Unlock Universe Values by acquiring multiple suites."
