...
const serviceIntelligenceReport: { id: string; title: string; status: ServiceStatus; analysis: string; }[] = [
    {
        id: "meta-auto-pilot",
        title: "Meta Auto Pilot",
        status: "Needs Integration",
        analysis: "The AI flow exists to generate a campaign plan, but it does not actually publish or interact with the Meta API. A full integration is required."
    },
    {
        id: "campaign-builder",
    ...
    },
    {
        ...
        status: "Deprecated",
        analysis: "This tool is correctly marked as deprecated and guides users to newer, more specialized tools. No action needed."
    },
     {
        id: "market-trends",
  ...
  return (
    <main className="p-4 md:p-10 space-y-8">
      <PageHeader
        ...
        description="A real-time analysis of all application services, their status, and any required actions."
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
       ...
       <Card>
        <CardHeader>
            ...
            <CardDescription>An overview of each service, its current status, and a summary of the AI's analysis.</CardDescription>
        </CardHeader>
        <CardContent>
