...
import { LineChart, Users2, Eye, Target, Sparkles, Download, ArrowRight, TrendingUp, FileText, Building, Database, BarChart, FileJson, BrainCircuit } from 'lucide-react';
...
const dataProducts = [
    {
        ...
        description: "Access our proprietary, AI-generated market segments like 'High-Yield Rental Hotspots' or 'Emerging Luxury Corridors' to power your own applications."
    },
    {
        title: "Automated Agent Reports",
        icon: <FileText className="h-8 w-8" />,
        description: "Subscribe to reports generated by our 'Learned Agents' that cover market trends, pricing analysis, and sentiment, delivered directly to your inbox."
    },
    {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <PageHeader
        ...
        description="Your gateway to the industry's most comprehensive and actionable real estate intelligence. Access our unique Smart Segments and Learned Agents via API or subscribe to automated reports."
