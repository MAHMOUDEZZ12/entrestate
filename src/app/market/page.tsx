...
const dataProducts = [
    {
        ...
        description: "Integrate our verified, real-time property and market data directly into your applications. Perfect for custom analytics, CRMs, or client-facing portals."
    },
    {
        title: "Automated Reports",
        icon: <FileText className="h-8 w-8" />,
        description: "Receive daily, weekly, or monthly reports covering market trends, pricing analysis, and sentiment, delivered directly to your inbox."
    },
    {
        title: "Digital Ads Intelligence",
        icon: <BarChart className="h-8 w-8" />,
        description: "Get a full breakdown of advertising performance across the market, including competitor spend, creative strategies, and audience engagement."
    },
    {
        title: "Full Market Datasets",
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <PageHeader
        ...
        description="Your gateway to the industry's most comprehensive and actionable real estate intelligence. Access our data via API or subscribe to automated reports."
           ...
           <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    ...
                    <p className="text-lg text-muted-foreground mt-4 max-w-3xl mx-auto">
                      Power your business with direct access to our verified, AI-enriched market intelligence.
                    </p>
                </div>
