...
const suiteTools = tools.filter(tool => tool.suite === 'Core AI');

export default function CoreAiDashboardPage() {
    return (
        <main className="p-4 md:p-10 space-y-8">
            <PageHeader
                title="Core AI Dashboard"
                description="The foundational AI agents that power the platform's intelligence and memory."
