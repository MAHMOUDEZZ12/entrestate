...
const suiteTools = tools.filter(tool => tool.suite === 'AI Creative Studio');
    ...
    return (
        <main className="p-4 md:p-10 space-y-8">
            <PageHeader
                ...
                description="Your one-stop-shop for generating all types of creative content, from videos to logos."
