...
const suiteTools = tools.filter(tool => tool.suite === 'Marketing Management');

export default function MarketingManagementDashboardPage() {
    return (
        <main className="p-4 md:p-10 space-y-8">
            <PageHeader
                title="Marketing Management Dashboard"
                description="High-level tools for managing your brand, communications, and sales processes."
