...
const suiteTools = tools.filter(tool => tool.suite === 'Utility');

export default function UtilityDashboardPage() {
    return (
        <main className="p-4 md:p-10 space-y-8">
            <PageHeader
                title="Utility Tools Dashboard"
                description="Developer and utility tools for managing the platform and advanced tasks."
