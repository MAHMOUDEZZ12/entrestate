...
const suiteTools = tools.filter(tool => tool.suite === 'Web Development Lab');
    ...
    return (
        <main className="p-4 md:p-10 space-y-8">
            <PageHeader
                ...
                description="Tools for creating and managing your online presence, from landing pages to chatbots."
