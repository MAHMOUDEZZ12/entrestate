        ...
        faqs: [
            {
                ...
                answer: "Entrestate is an AI-native operating system for the real estate industry. It integrates market intelligence, creative tooling, and campaign automation into a single, seamless cockpit to give professionals an unparalleled advantage."
            },
            {
                question: "How does the system work?",
                answer: "Our system is built on a modular, event-driven architecture. Each tool is an AI-powered 'Service Card' that connects to a central core of your data (Brand Kit, Projects, etc.). You can use these cards individually or chain them together in automated 'Flows' to perform complex tasks."
            },
            {
        ...
        faqs: [
            {
                ...
                answer: "An 'App' is a single tool that performs a specific task (e.g., Insta Ads Designer). A 'Flow' is an automated workflow you can build by chaining multiple apps together. A 'Pilot' is a master AI orchestrator, like the Meta Auto Pilot, that can intelligently run other tools to achieve a high-level goal."
            },
            {
        ...
        <div className="mt-12">
            <Tabs defaultValue={faqData[0].category} className="w-full">
              <TabsList className="grid w-full grid-cols-2 md:grid-cols-3 lg:grid-cols-6 h-auto">
                {faqData.map(cat => (
                    <TabsTrigger key={cat.category} value={cat.category} className="flex-col h-auto py-3 gap-1">
                        {cat.icon}
