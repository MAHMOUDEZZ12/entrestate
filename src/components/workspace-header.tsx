...
import { LogOut, Settings, LayoutGrid, Palette, Workflow, Store, Database, Target, Users2, School, BookOpen, Brain, GanttChartSquare, User as UserIcon } from 'lucide-react';
