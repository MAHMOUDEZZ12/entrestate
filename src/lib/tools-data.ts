...
export const tools: ToolData[] = [
    ...
    { id: 'audience-creator', title: 'Brand Search Optimization', description: 'The watcher agent that finds, analyzes, and optimizes your target audience for brand search.', iconName: 'Users2', color: '#4B0082', categories: ['Market Intelligence', 'Lead Gen'], cta: 'Create Audience' },
    ...
    { id: 'keyword-planner', title: 'Keyword Planner', description: 'Generate strategic keyword plans for Google Ads to capture high-intent leads.', iconName: 'Search', color: '#4285F4', categories: ['Marketing', 'Ads'], cta: 'Create Plan' },
