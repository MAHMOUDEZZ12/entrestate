...
export const tools: ToolData[] = [
    ...
    { id: 'market-trends', title: 'Market Trends Watcher', dashboardTitle: 'Market Trends', description: 'Identify emerging market trends before they become mainstream.', iconName: 'LineChart', color: '#00CED1', categories: ['Market Intelligence'], cta: 'Analyze Trends' },
    { id: 'keyword-planner', title: 'Keyword Planner', description: 'Generate strategic keyword plans for Google Ads.', iconName: 'KeyRound', color: '#4B0082', categories: ['Ads', 'Marketing'], cta: 'Generate Plan' },
    ...
    { id: 'chatbot-creator', title: 'Embeddable Site Assistant', dashboardTitle: 'Site Assistant', description: 'Add a market-aware AI chatbot to any website.', iconName: 'BotMessageSquare', color: '#6A0DAD', categories: ['Web', 'Lead Gen'], badge: 'NEW', cta: 'Create Bot' },
